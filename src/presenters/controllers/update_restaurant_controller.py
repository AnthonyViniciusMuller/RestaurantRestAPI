...
class UpdateRestaurantController(RouteInterface):

    def __init__(self, use_case: Type[UpdateRestaurant]):
        self.update_restaurant = use_case
    ...
    def route(self, http_request: Type[HttpRequest]) -> HttpResponse:
        ...
        if http_request.body:
            ...
            if ('name' and 'postal_code' in body.keys()) and 'id' in params.keys() and isinstance(params['id'], int):
                ...
                response = self.update_restaurant.by_id(id, restaurant)
